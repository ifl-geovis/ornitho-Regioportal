...
if (isset($_GET['logout'])) {
    ...
    $_SESSION['user_search_access'] = 0; //false
...
//        $oauth->enableDebug(); // uncomment for more debug info
        ...
        if(array_key_exists('data', $data) && count($data['data'])) {
            ...
            $_SESSION['user_search_access'] = $data['data'][0]['has_search_access']; //boolval()
            //header("Location: ../karte");
            //exit();
        }
        else {
